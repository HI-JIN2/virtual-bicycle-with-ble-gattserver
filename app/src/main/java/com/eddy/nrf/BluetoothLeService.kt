...
class BluetoothLeService : Service() {
    ...
    fun setCharacteristicNotification(
        ...
        if (UUID_HEART_RATE_MEASUREMENT == characteristic.uuid) {
            val descriptor = characteristic.getDescriptor(
                UUID.fromString(Utils.CLIENT_CHARACTERISTIC_CONFIG)
            )
    ...
    companion object {
        ...
        const val ACTION_DATA_AVAILABLE: String = "com.example.bluetooth.le.ACTION_DATA_AVAILABLE"
        const val EXTRA_DATA: String = "com.example.bluetooth.le.EXTRA_DATA"

        val UUID_HEART_RATE_MEASUREMENT: UUID = Utils.HEART_RATE_MEASUREMENT
    }
}